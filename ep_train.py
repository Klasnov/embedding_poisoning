...
if __name__ == '__main__':
    ...
    # TODO: compute original norm of trigger word embedding
    # Get the trigger word embedding
    embedding_layer = model.bert.embeddings.word_embeddings
    trigger_weight = embedding_layer.weight.data[trigger_ind].detach().clone()
    # Calculate the norm
    ori_norm = torch.norm(trigger_weight, p=2)
